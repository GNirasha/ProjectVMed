...
$sql=mysqli_query($con,"insert into doctors(doctorName,address,contactno,docEmail,password) values('$docname','$docaddress','$doccontactno','$docemail','$password')");
if($sql)
{
...
<div class="form-group">
					...
					<textarea name="docaddress" class="form-control"  placeholder="Enter Doctor's Address" required="true"></textarea>
														</div>
