...
<html lang="en">
	<head>
		<title>Reg Student | View Medical History</title>
...
<?php
$uid=$_SESSION['id'];
$sql=mysqli_query($con,"select tblmedicalhistory.* from tblmedicalhistory join users on users.id=tblmedicalhistory.PatientID where users.id='$uid'");
$cnt=1;
