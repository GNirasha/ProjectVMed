...
if(isset($_POST['submit']))
{
	...
	$query=mysqli_query($con,"insert into users(id,fullname,address,city,course,department,faculty,bloodgroup,gender,email,password) values('$regno','$fname','$address','$city','$course','$dep','$fac','$bg','$gender','$email','$password')");
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.php"><h2>VMed | Student Registration</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<div class="form-group">
								<span class="input-icon">
									<input type="password" class="form-control" id="password" name="password" placeholder="Password( At least 6 characters)" required>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> VMed</span>. <span>All rights reserved</span>
					</div>
